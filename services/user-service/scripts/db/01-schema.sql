/*
  ...
  Schema này được thiết kế cho user-service trong dự án ecommerce-microservices.
  Các bảng và cấu trúc phù hợp với mô hình dữ liệu từ cả backend (Go) và frontend (React).
  
  Nguyên tắc chính:
  - Mỗi người dùng có thể có nhiều địa chỉ giao hàng
  - Mỗi người dùng có thể có nhiều phương thức thanh toán
  - Mỗi người dùng có thể có danh sách sản phẩm yêu thích
  - Username được tạo tự động từ lastName + firstName
*/
