...
const CartTotals: React.FC = () => {
  ...
  return (
    <div className="bg-white rounded-lg shadow p-5 ">
      ...
      <button className="text-sans mt-4 w-full bg-[#FA8232] text-white py-3 px-4 rounded flex items-center justify-center font-medium hover:bg-orange-600 transition-colors">
        PROCEED TO CHECKOUT
