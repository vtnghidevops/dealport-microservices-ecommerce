...
export default function HeroBanner() {
  ...
  return (
    <div className="relative w-full  text-white h-[500px] m-h-[500px]">
      ...
      <div className="w-full bg-cyprus h-full relative">
        <img
          src="images/slidebar/slidebar-1.png"
          alt="Clothing rack"
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-16 mb-[5rem]">
          <div>
            <h2 className="header-2 ml-[10.5rem]">
              Discover the Latest Deals –
            </h2>
            <p className="header-1 mb-6 ml-[10rem] italic">Up to 50% Off!</p>
          </div>
